...
<body>
    <div id="app">
       <nav class="navbar navbar-expand-lg navbar-light fixed-top" id="mainNav" style="background-color: rgba(255,102, 0, 0.8)">
            <div class="container">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        @guest
                            ...
                            @if (Route::has('register'))
                                <li class="nav-item">
                                    <a class="nav-link" href="{{ route('register') }}">{{ __('Join as Organization') }}</a>
                                </li>
                            @endif
                        @else
                        <li>
